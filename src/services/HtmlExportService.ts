// =============================================================================
// HtmlExportService — renders the entire builder state to a standalone,
// self-contained HTML document (inline CSS/JS, embedded state JSON).
//
// This is pure: given a snapshot of the current variants/elements/connections/
// brush/guides/theme, it returns the exported HTML string. Moved verbatim from
// BuilderContext.exportHTML — logic is unchanged.
// =============================================================================
...
import { getAdaptedTextColor, getAdaptedBorderColor } from './element-accessors';
...
/** Render the builder state to a standalone HTML document string. */
export function generateExportHTML(snapshot: ExportSnapshot): string {
  const { variants, activeVariantId, elements, connections, brushStrokes, guides, theme } = snapshot;
